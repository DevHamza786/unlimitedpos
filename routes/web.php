...
Route::middleware(['setData'])->group(function () {
    ...
    Route::post('/webhook/woocommerce/{token}', [WooCommerceWebhookController::class, 'order'])
        ->name('webhook.woocommerce_order');
});
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/sells/pos/get-auto-discount-details', [SellPosController::class, 'getAutoDiscountDetails']);
